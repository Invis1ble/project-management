...
final readonly class StatusBackendMergeRequestIntoDevelopmentBranchCreated extends AbstractStatus
{
    public function proceedToNext(
        ...
        $this->setPublicationStatus($publication, new StatusBackendMergeRequestIntoDevelopmentBranchMerged());
    }

    public function __toString(): string
    {
        return Dictionary::BackendMergeRequestIntoDevelopmentBranchCreated->value;
    }
}
