...
final readonly class StatusBackendMergeRequestIntoProductionReleaseBranchCreated extends AbstractStatus
{
    public function proceedToNext(
        ...
        $this->setPublicationStatus($publication, new StatusBackendMergeRequestIntoProductionReleaseBranchMerged());
    }

    public function __toString(): string
    {
        return Dictionary::BackendMergeRequestIntoProductionReleaseBranchCreated->value;
    }
}
