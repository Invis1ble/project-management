...
final readonly class StatusBackendMergeRequestIntoProductionReleaseBranchMerged extends AbstractStatus
{
    ...
    {
        return Dictionary::BackendMergeRequestIntoProductionReleaseBranchMerged->value;
    }
}
