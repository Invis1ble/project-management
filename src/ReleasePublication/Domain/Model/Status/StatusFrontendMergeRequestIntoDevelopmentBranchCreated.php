...
final readonly class StatusFrontendMergeRequestIntoDevelopmentBranchCreated extends AbstractStatus
{
    ...
    {
        return Dictionary::FrontendMergeRequestIntoDevelopmentBranchCreated->value;
    }
}
