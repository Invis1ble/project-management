...
final readonly class StatusFrontendMergeRequestIntoReleaseBranchCreated extends AbstractStatus
{
    public function proceedToNext(
        ...
        $this->setPublicationStatus($context, new StatusFrontendReleaseBranchSynchronized());
    }

    public function __toString(): string
    {
        return Dictionary::FrontendMergeRequestIntoReleaseBranchCreated->value;
    }
}
