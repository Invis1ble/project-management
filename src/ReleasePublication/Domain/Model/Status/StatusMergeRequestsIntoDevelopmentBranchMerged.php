...
final readonly class StatusMergeRequestsIntoDevelopmentBranchMerged extends AbstractStatus
{
    ...
    {
        return Dictionary::MergeRequestsIntoDevelopmentBranchMerged->value;
    }
}
