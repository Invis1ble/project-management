...
/**
 * @extends AbstractFormatter<ReleasePublicationCreated>
 */
final readonly class ReleasePublicationCreatedFormatter extends AbstractFormatter
{
    public function supports(EventInterface $event): bool
    {
        return $event instanceof ReleasePublicationCreated;
    }
