...
/**
 * @extends AbstractPipelineEventFormatter<PipelineStuck>
 */
final readonly class PipelineStuckFormatter extends AbstractPipelineEventFormatter
{
    public function supports(EventInterface $event): bool
    {
        return $event instanceof PipelineStuck;
    }

    public function format(EventInterface $event): string
    {
        return "Pipeline {$this->pipelineKey($event)} stuck";
    }
}
