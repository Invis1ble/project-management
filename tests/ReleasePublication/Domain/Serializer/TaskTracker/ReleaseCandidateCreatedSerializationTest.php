...
/**
 * @extends SerializationTestCase<ReleaseCandidateCreated>
 */
class ReleaseCandidateCreatedSerializationTest extends SerializationTestCase
{
    protected function createObject(): ReleaseCandidateCreated
    {
