...
use Invis1ble\ProjectManagement\ReleasePublication\Infrastructure\Domain\EventLog\EventFormatter\ReleasePublicationCreatedFormatter;
...
/**
 * @extends EventFormatterTestCase<ReleasePublicationCreated>
 */
class ReleasePublicationCreatedFormatterTest extends EventFormatterTestCase
{
    protected function createEventFormatter(): ReleasePublicationCreatedFormatter
    {
        return new ReleasePublicationCreatedFormatter();
    }

    protected function createEvent(): ReleasePublicationCreated
    {
    ...
    {
        return "Release publication $event->id `$event->tagName` created";
    }
}
