...
use Invis1ble\ProjectManagement\ReleasePublication\Infrastructure\Domain\EventLog\EventFormatter\ReleasePublicationTagSetFormatter;
...
/**
 * @extends EventFormatterTestCase<ReleasePublicationTagSet>
 */
class ReleasePublicationTagSetFormatterTest extends EventFormatterTestCase
{
    protected function createEventFormatter(): ReleasePublicationTagSetFormatter
    {
        return new ReleasePublicationTagSetFormatter();
    }

    protected function createEvent(): ReleasePublicationTagSet
    {
