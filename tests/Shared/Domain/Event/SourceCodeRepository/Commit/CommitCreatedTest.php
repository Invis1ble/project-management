...
namespace Invis1ble\ProjectManagement\Tests\Shared\Domain\Event\SourceCodeRepository\Commit;
 ...
 */
class CommitCreatedTest extends SerializationTestCase
{
    protected function createObject(): CommitCreated
    {
        ...
        return new CommitCreated(
            ...
            guiUrl: $uriFactory->createUri('https://example.com/commit/1234567890abcdef1234567890abcdef12345678'),
