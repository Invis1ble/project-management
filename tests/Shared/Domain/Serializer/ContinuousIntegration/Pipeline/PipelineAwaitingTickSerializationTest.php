...
/**
 * @extends SerializationTestCase<PipelineAwaitingTick>
 */
class PipelineAwaitingTickSerializationTest extends SerializationTestCase
{
    protected function createObject(): PipelineAwaitingTick
    {
