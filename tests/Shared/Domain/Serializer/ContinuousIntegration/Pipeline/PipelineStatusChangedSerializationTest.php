...
/**
 * @extends SerializationTestCase<PipelineStatusChanged>
 */
class PipelineStatusChangedSerializationTest extends SerializationTestCase
{
    protected function createObject(): PipelineStatusChanged
    {
