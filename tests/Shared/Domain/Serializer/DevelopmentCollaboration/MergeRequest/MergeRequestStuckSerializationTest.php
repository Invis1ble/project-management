...
/**
 * @extends SerializationTestCase<MergeRequestStuck>
 */
class MergeRequestStuckSerializationTest extends SerializationTestCase
{
    protected function createObject(): MergeRequestStuck
    {
