...
use Invis1ble\ProjectManagement\Shared\Infrastructure\Domain\EventLog\EventFormatter\ContinuousIntegration\Pipeline\PipelineRetriedFormatter;
use Invis1ble\ProjectManagement\Tests\Shared\Infrastructure\Domain\EventLog\EventFormatter\EventFormatterTestCase;

/**
 * @extends EventFormatterTestCase<PipelineRetried>
 */
class PipelineRetriedFormatterTest extends EventFormatterTestCase
{
    protected function createEventFormatter(): PipelineRetriedFormatter
    {
        return new PipelineRetriedFormatter();
    }

    protected function createEvent(): PipelineRetried
    {
    ...
    {
        return "Pipeline $event->guiUrl retried";
    }
}
