...
use Invis1ble\ProjectManagement\Shared\Infrastructure\Domain\EventLog\EventFormatter\ContinuousIntegration\Pipeline\PipelineStuckFormatter;
use Invis1ble\ProjectManagement\Tests\Shared\Infrastructure\Domain\EventLog\EventFormatter\EventFormatterTestCase;

/**
 * @extends EventFormatterTestCase<PipelineStuck>
 */
class PipelineStuckFormatterTest extends EventFormatterTestCase
{
    protected function createEventFormatter(): PipelineStuckFormatter
    {
        return new PipelineStuckFormatter();
    }

    protected function createEvent(): PipelineStuck
    {
    ...
    {
        return "Pipeline $event->guiUrl stuck";
    }
}
