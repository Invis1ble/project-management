...
use Invis1ble\ProjectManagement\Shared\Infrastructure\Domain\EventLog\EventFormatter\DevelopmentCollaboration\MergeRequest\MergeRequestStuckFormatter;
use Invis1ble\ProjectManagement\Tests\Shared\Infrastructure\Domain\EventLog\EventFormatter\EventFormatterTestCase;

/**
 * @extends EventFormatterTestCase<MergeRequestStuck>
 */
class MergeRequestStuckFormatterTest extends EventFormatterTestCase
{
    protected function createEventFormatter(): MergeRequestStuckFormatter
    {
        return new MergeRequestStuckFormatter();
    }

    protected function createEvent(): MergeRequestStuck
    {
        return new MergeRequestStuck(
